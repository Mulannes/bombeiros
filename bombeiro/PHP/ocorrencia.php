...
<body>
    ...
    <div class="container-fluid m-0 p-0">
        ...
        <div class="container d-flex justify-content-around align-items-center ">
            <a href="../PHP/doRegister.php"><img src="../images/registro1.png" width="200px"></a>
            <a href="../HTML/registro.html"><img src="../images/registro2.png" width="185px"></a>
        </div>
        <br>
        <div class="text">
            ...
            <div class="nav-pills-style" style="width: 95%; height: 75px; flex-shrink: 0; border-radius: 50px; background: #FFF; box-shadow: 0px 0px 100px 0px rgba(0, 0, 0, 0.50);">
                <ul class="nav nav-pills nav-justified">
                    ...
                    <li class="nav-item" style="max-height: 65px;">
                        ...
                        <a class="nav-link" href="../HTML/ocorrencia.html" style="color: #C21219; padding: 0; font-size: 14px; font-weight: bold; height: 28px; line-height: 13px;">Fazer<br>Registro</a>
                    </li>
                    <li class="nav-item" style="max-height: 65px;">
