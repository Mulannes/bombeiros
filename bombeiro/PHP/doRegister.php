...
<body>
  <div class="container-fluid">
    ...
    <div class="accordion-body" style="padding: 0;">
        <div class="row justify-content-center fs-4">Nível de consciência</div>
        <div class="row h-auto" style="font-size: 12px;">
            <div class="col-2 w-10" style="transform: rotate(90deg); font-size: 16px; font-family: 'Courier New', Courier, monospace; padding-bottom: 20px; height: 50px;">
                Abertura ocular
            </div>
            <div class="col-5" id="maior5" style="display: block;">Maiores de 5 anos <br>
                <div class="col-auto">
                    <input class="form-check-input" type="radio" name="aberturaOcular" value="Espontanea" id="flexCheckDefault20">
                    <label class="form-check-label" for="flexCheckDefault20">
                        Espontânea
                    </label>
                </div>
                <div class="col-auto">
                    <input class="form-check-input" type="radio" name="aberturaOcular" value="ComandoVerbal" id="flexCheckDefault21">
                    <label class="form-check-label" for="flexCheckDefault21">
                        Comando Verbal
                    </label>
                </div>
                <div class="col-auto">
                    <input class="form-check-input" type="radio" name="aberturaOcular" value="EstimuloDoloroso" id="flexCheckDefault22">
                    <label class="form-check-label" for="flexCheckDefault22">
                        Estímulo Doloroso
                    </label>
                </div>
                <div class="col-auto">
                    <input class="form-check-input" type="radio" name="aberturaOcular" value="Nenhuma" id="flexCheckDefault23">
              ...
              <div class="col-5 none" id="menor5" style="display: none;">Menores de 5 anos <br>
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="aberturaOcular2" value="Espontanea" id="flexCheckDefault24">
                  <label class="form-check-label" for="flexCheckDefault24">
                    Espontânea
                  </label>
                </div>
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="aberturaOcular2" value="ComandoVerbal" id="flexCheckDefault25">
                  <label class="form-check-label" for="flexCheckDefault25">
                    Comando Verbal
                  </label>
                </div>
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="aberturaOcular2" value="EstimuloDoloroso" id="flexCheckDefault26">
                  <label class="form-check-label" for="flexCheckDefault26">
                    Estímulo Doloroso
                  </label>
                </div>
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="aberturaOcular2" value="Nenhuma" id="flexCheckDefault27">
            ...
            <div class="row h-auto" style="font-size: 12px;">
              ...
              <div class="col-5">
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="RespostaVerbal" id="flexCheckDefault28">
                  <label class="form-check-label" for="flexCheckDefault28">
                    Orientado
                  </label>
                </div>
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="RespostaVerbal" id="flexCheckDefault29">
                  <label class="form-check-label" for="flexCheckDefault29">
                    Confuso
                  </label>
                </div>
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="RespostaVerbal" id="flexCheckDefault30">
                  <label class="form-check-label" for="flexCheckDefault30">
                    Palavras <br>inapropriadas
                  </label>
                </div>
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="RespostaVerbal" id="flexCheckDefault31">
                  <label class="form-check-label" for="flexCheckDefault31">
                    Palavras <br>incompreensível
                  </label>
                </div>
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="RespostaVerbal" id="flexCheckDefault32">
                  <label class="form-check-label" for="flexCheckDefault32">
                    Nenhuma
                  </label>
                </div>
              </div>
              <div class="col-5 none" style="display: none;">
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="RespostaVerbal2" id="flexCheckDefault33">
                  <label class="form-check-label" for="flexCheckDefault33">
                    Palavras e frases <br>apropriadas
                  </label>
                </div>
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="RespostaVerbal2" id="flexCheckDefault34">
                  <label class="form-check-label" for="flexCheckDefault34">
                    Palavras <br>inapropriadas
                  </label>
                </div>
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="RespostaVerbal2" id="flexCheckDefault35" placeholder="1">
                  <label class="form-check-label" for="flexCheckDefault35">
                    Choro persistente <br>ou gritos
                  </label>
                </div>
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="RespostaVerbal2" id="flexCheckDefault36">
                  <label class="form-check-label" for="flexCheckDefault36">
                    Sons <br>incompreensível
                  </label>
                </div>
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="RespostaVerbal2" id="flexCheckDefault37">
            ...
            <div class="row h-auto" style="font-size: 12px;">
              ...
              <div class="col-4 p-0">
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="RespostaMotora" id="flexCheckDefault38">
                  <label class="form-check-label" for="flexCheckDefault38">
                    Obedece <br>comandos
                  </label>
                </div>
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="RespostaMotora" id="flexCheckDefault39">
                  <label class="form-check-label" for="flexCheckDefault39">
                    Localiza dor
                  </label>
                </div>
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="RespostaMotora" id="flexCheckDefault40">
                  <label class="form-check-label" for="flexCheckDefault40">
                    Movimento de <br>retirada
                  </label>
                </div>
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="RespostaMotora" id="flexCheckDefault41">
                  <label class="form-check-label" for="flexCheckDefault41">
                    Flexão anormal
                  </label>
                </div>
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="RespostaMotora" id="flexCheckDefault42">
                  <label class="form-check-label" for="flexCheckDefault42">
                    Extensão <br>anormal
                  </label>
                </div>
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="RespostaMotora" id="flexCheckDefault43">
                  <label class="form-check-label" for="flexCheckDefault43">
                    Nenhuma
                  </label>
                </div>
              </div>
              <div class="col-6 p-0 none" style="display: none;">
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="RespostaMotora2" id="flexCheckDefault44">
                  <label class="form-check-label" for="flexCheckDefault44">
                    Obedece prontamente
                  </label>
                </div>
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="RespostaMotora2" id="flexCheckDefault45">
                  <label class="form-check-label" for="flexCheckDefault45">
                    Localiza dor ou <br>estímulo tatil
                  </label>
                </div>
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="RespostaMotora2" id="flexCheckDefault46">
                  <label class="form-check-label" for="flexCheckDefault46">
                    Retirada do segmento <br>estímulado
                  </label>
                </div>
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="RespostaMotora2" id="flexCheckDefault47">
                  <label class="form-check-label" for="flexCheckDefault47">
                    Flexão anormal <br>(decorticação)
                  </label>
                </div>
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="RespostaMotora2" id="flexCheckDefault48">
                  <label class="form-check-label" for="flexCheckDefault48">
                    Extensão anormal <br>(decerfração)
                  </label>
                </div>
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="RespostaMotora2" id="flexCheckDefault49">
        ...
        <div id="panelsStayOpen-collapseFour" class="accordion-collapse collapse"
          ...
          <div class="accordion-body">
            <div class="row">
              ...
              <div class="col-4"><input type="text" name="Pressão arterial0" class="form-control" placeholder="mmHg">
              </div>X
              <div class="col-4"><input type="text" name="Pressão arterial1" class="form-control" placeholder="mmHg">
              </div>
            </div>
            <div class="row">
              <div class="col-4">Pulso:</div>
              <div class="col-8"><input type="text" name="Pulso" class="form-control" placeholder="B.C.P.M"></div>
            </div>
            <div class="row">
              <div class="col-4">Respiração:</div>
              <div class="col-8"><input type="text" name="Respiracao" class="form-control" placeholder="M.R.M"></div>
            </div>
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-4" style="padding: 0; display: flex; align-items: center;"><input type="checkbox"
                  name="anormalTemp" class="form-check-input" id="anormalTemp">
            ...
            <div class="row">
              ...
              <div class="col-4" style="padding: 0; display: flex; align-items: center;"><input type="checkbox"
                  name="perfusão" class="form-check-input" id="normalPerf">
      ...
      <div class="accordion-item">
        ...
        <div id="panelsStayOpen-collapseFive" class="accordion-collapse collapse"
          ...
          <div class="accordion-body">
            <div class="row" style="height: 125px; font-size: 12px; align-items: center; ">
              <div class="col-3"><input class="form-check-input" type="checkbox" name="Psiquiátrico" id="Psiquiátrico">
                <label class="form-check-label" for="Psiquiátrico">
                  Psiquiátrico
                </label>
              </div>
              <div class="col-3"><input class="form-check-input" type="checkbox" name="Obstérico" id="Obstérico">
                <label class="form-check-label" for="Obstérico">
                  Obstérico
                </label>
              </div>
              <div class="col-6"><input class="form-check-input" type="checkbox" name="PartoEmergencial"
                  id="PartoEmergencial" style="display: block;">
                ...
                <label class="form-check-label" for="Gestante">
                  Gestante
                </label><input class="form-check-input" type="checkbox" name="Hemor" id="Hemor" style="display: block;">
            ...
            <div class="row" style="height: 125px; font-size: 12px; align-items: center;">
              <div class="col-3"><input class="form-check-input" type="checkbox" name="Respiratório" id="Respiratório">
                <label class="form-check-label" for="Respiratório">
                  Respiratório
                </label>
              </div>
              <div class="col-3"><input class="form-check-input" type="checkbox" name="DPOC" id="DPOC"
                  style="display: block;">
              ...
              <div class="col-3"><input class="form-check-input" type="checkbox" name="Diabetes" id="Diabetes">
                <label class="form-check-label" for="Diabetes">
                  Diabetes
                </label>
              </div>
              <div class="col-3"><input class="form-check-input" type="checkbox" name="Hiperglicemia" id="Hiperglicemia"
                  style="display: block;">
                <label class="form-check-label" for="Hiperglicemia">
                  Hiperglicemia
                </label><input class="form-check-input" type="checkbox" name="Hipoglicemia" id="Hipoglicemia"
                  style="display: block;">
            ...
            <div class="row" style="height: 180px; font-size: 12px; align-items: center; ">
              <div class="col-3"><input class="form-check-input" type="checkbox" name="Transporte" id="Transporte">
                <label class="form-check-label" for="Transporte">
                  Transporte
                </label>
              </div>
              <div class="col-9" style="position: relative;"><input class="form-check-input" type="checkbox"
                ...
                <label class="form-check-label" for="Aereo" style="position: absolute; top: 0;left: 32px;">
                  ...
                  style="display: block;">
                <label class="form-check-label" for="Clinico" style="position: absolute; top: 20px;left: 32px;">
                  Clínico
                </label><input class="form-check-input" type="checkbox" name="Emergencial" id="Emergencial"
                  style="display: block;">
                <label class="form-check-label" for="Emergencial" style="position: absolute; top: 40px;left: 32px;">
                  Emergencial
                </label><input class="form-check-input" type="checkbox" name="potrauma" id="potrauma"
                  style="display: block;">
                <label class="form-check-label" for="potrauma" style="position: absolute; top: 60px;left: 32px;">
                  Pós-trauma
                </label><input class="form-check-input" type="checkbox" name="Samu" id="Samu" style="display: block;">
                <label class="form-check-label" for="Samu" style="position: absolute; top: 80px;left: 32px;">
                  Samu
                </label><input class="form-check-input" type="checkbox" name="Outros" id="Outros"
                  style="display: block;">
                <label class="form-check-label" for="Outros" style="position: absolute; top: 100px;left: 32px;">
                  Outros
                </label><input type="text" class="form-control">
                <input class="form-check-input" type="checkbox" name="noRemocao" id="noRemocao" style="display: block;">
                <label class="form-check-label" for="noRemocao" style="position: absolute; top: 158px;left: 32px;">
                  Sem remoção
                </label>
              </div>
            </div>
        ...
        <div id="panelsStayOpen-collapseSix" class="accordion-collapse collapse"
          ...
          <div class="accordion-body">
            <div class="container">
              ...
              <div class="row" style="position: relative;">
                <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault167" name="fraturas">
        ...
        <div id="panelsStayOpen-collapseEight" class="accordion-collapse collapse"
          ...
          <div class="accordion-body">
            <div class="row" style="position: relative;">
              ...
              <label class="form-check-label" for="flexCheckDefault50" style="position: absolute; top: 0;left: 32px;">
                Abdômen sensível ou rígido
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault51">
              <label class="form-check-label" for="flexCheckDefault51" style="position: absolute; top: 0;left: 32px;">
                Afundamento de crânio
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault52">
              <label class="form-check-label" for="flexCheckDefault52" style="position: absolute; top: 0;left: 32px;">
                Agitação
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault53">
              <label class="form-check-label" for="flexCheckDefault53" style="position: absolute; top: 0;left: 32px;">
                Amnésia
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault54">
              <label class="form-check-label" for="flexCheckDefault54" style="position: absolute; top: 0;left: 32px;">
                Angna de peito
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault55">
              <label class="form-check-label" for="flexCheckDefault55" style="position: absolute; top: 0;left: 32px;">
                Apinéia
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault56">
              <label class="form-check-label" for="flexCheckDefault56" style="position: absolute; top: 0;left: 32px;">
                Bradicardia
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault57">
              <label class="form-check-label" for="flexCheckDefault57" style="position: absolute; top: 0;left: 32px;">
                Bradipneia
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault58">
              <label class="form-check-label" for="flexCheckDefault58" style="position: absolute; top: 0;left: 32px;">
                Bronco aspirando
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault59">
              <label class="form-check-label" for="flexCheckDefault59" style="position: absolute; top: 0;left: 32px;">
                Cefaleia
              </label>
            </div>
            <div class="row" style="display: flex; align-items: center;">
              ...
              <div class="col-6" style="position: relative;">
                <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault61"
                  style="display: block; ">
                <label class="form-check-label" for="flexCheckDefault61" style="position: absolute; top: 0;left: 32px;">
                  Lábios
                </label>
            ...
            <div class="row" style="position: relative;">
              ...
              <label class="form-check-label" for="flexCheckDefault63" style="position: absolute; top: 0;left: 32px;">
                Convulsão
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault64">
              <label class="form-check-label" for="flexCheckDefault64" style="position: absolute; top: 0;left: 32px;">
                Decorticação
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault65">
              <label class="form-check-label" for="flexCheckDefault65" style="position: absolute; top: 0;left: 32px;">
                Deformidade
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault66">
              <label class="form-check-label" for="flexCheckDefault66" style="position: absolute; top: 0;left: 32px;">
                Descerebração
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault67">
              <label class="form-check-label" for="flexCheckDefault67" style="position: absolute; top: 0;left: 32px;">
                Desmaio
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault68">
              <label class="form-check-label" for="flexCheckDefault68" style="position: absolute; top: 0;left: 32px;">
                Desvio de traquéia
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault69">
              <label class="form-check-label" for="flexCheckDefault69" style="position: absolute; top: 0;left: 32px;">
                Despinéia
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault70">
              <label class="form-check-label" for="flexCheckDefault70" style="position: absolute; top: 0;left: 32px;">
                Dor local
              </label>
            </div>
            <div class="row" style="display: flex; align-items: center;">
              ...
              <div class="col-6" style="position: relative;">
                <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault72"
                  style="display: block; ">
                <label class="form-check-label" for="flexCheckDefault72" style="position: absolute; top: 0;left: 32px;">
                  Generalizado
                </label>
            ...
            <div class="row" style="position: relative;">
              ...
              <label class="form-check-label" for="flexCheckDefault74" style="position: absolute; top: 0;left: 32px;">
                Enfisema subcutâneo
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault75">
              <label class="form-check-label" for="flexCheckDefault75" style="position: absolute; top: 0;left: 32px;">
                Êxtase de jugular
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault76">
              <label class="form-check-label" for="flexCheckDefault76" style="position: absolute; top: 0;left: 32px;">
                Face pálida
              </label>
            </div>
            <div class="row" style="display: flex; align-items: center;">
              ...
              <div class="col-6" style="position: relative;">
                <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault78"
                  style="display: block; ">
                <label class="form-check-label" for="flexCheckDefault78" style="position: absolute; top: 0;left: 32px;">
                  Interna
                </label>
            ...
            <div class="row" style="position: relative;">
              ...
              <label class="form-check-label" for="flexCheckDefault80" style="position: absolute; top: 0;left: 32px;">
                Hipertensão
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault81">
              <label class="form-check-label" for="flexCheckDefault81" style="position: absolute; top: 0;left: 32px;">
                Hipotensão
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault82">
              <label class="form-check-label" for="flexCheckDefault82" style="position: absolute; top: 0;left: 32px;">
                Náuseas e vômitos
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault83">
              <label class="form-check-label" for="flexCheckDefault83" style="position: absolute; top: 0;left: 32px;">
                Nasoragia
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault84">
              <label class="form-check-label" for="flexCheckDefault84" style="position: absolute; top: 0;left: 32px;">
                Óbito
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault85">
              <label class="form-check-label" for="flexCheckDefault85" style="position: absolute; top: 0;left: 32px;">
                Otorréia
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault86">
              <label class="form-check-label" for="flexCheckDefault86" style="position: absolute; top: 0;left: 32px;">
                Otorragia
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault87">
              <label class="form-check-label" for="flexCheckDefault87" style="position: absolute; top: 0;left: 32px;">
                O.V.A.C.E
              </label>
            </div>
            <div class="row" style="display: flex; align-items: center;">
              ...
              <div class="col-6" style="position: relative;">
                <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault89"
                  style="display: block; ">
                <label class="form-check-label" for="flexCheckDefault89" style="position: absolute; top: 0;left: 32px;">
                  Cardíaca
                </label>
            ...
            <div class="row" style="position: relative;">
              ...
              <label class="form-check-label" for="flexCheckDefault91" style="position: absolute; top: 0;left: 32px;">
                Priaprismo
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault92">
              <label class="form-check-label" for="flexCheckDefault92" style="position: absolute; top: 0;left: 32px;">
                Prurido na pele
              </label>
            </div>
            <div class="row" style="display: flex; align-items: center;">
              ...
              <div class="col-4" style="position: relative;">
                <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault94"
                  style="display: block; ">
                <label class="form-check-label" for="flexCheckDefault94" style="position: absolute; top: 0;left: 32px;">
                  Anisocoria
                </label>
              ...
              <div class="col-4" style="position: relative;">
                <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault98"
                  style="display: block; ">
                <label class="form-check-label" for="flexCheckDefault98" style="position: absolute; top: 0;left: 32px;">
                  Reagente
                </label>
            ...
            <div class="row" style="position: relative;">
              ...
              <label class="form-check-label" for="flexCheckDefault100" style="position: absolute; top: 0;left: 32px;">
                Sede
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault101">
              <label class="form-check-label" for="flexCheckDefault101" style="position: absolute; top: 0;left: 32px;">
                Sinal de battle
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault102">
              <label class="form-check-label" for="flexCheckDefault102" style="position: absolute; top: 0;left: 32px;">
                Sinal de guaxinim
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault103">
              <label class="form-check-label" for="flexCheckDefault103" style="position: absolute; top: 0;left: 32px;">
                Sudorese
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault104">
              <label class="form-check-label" for="flexCheckDefault104" style="position: absolute; top: 0;left: 32px;">
                Taquipnéia
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault105">
              <label class="form-check-label" for="flexCheckDefault105" style="position: absolute; top: 0;left: 32px;">
                Taquicardia
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault106">
              <label class="form-check-label" for="flexCheckDefault106" style="position: absolute; top: 0;left: 32px;">
                Tontura
              </label>
            </div>
            <div class="row" style="position: relative;">
      ...
      <div class="accordion-item">
        ...
        <div id="panelsStayOpen-collapseNine" class="accordion-collapse collapse"
          ...
          <div class="accordion-body">
            ...
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="Semi-Deitada" id="flexCheckDefaultSemiDeitada"
                name="forma_conducao">
      ...
      <div class="accordion-item">
        ...
        <div id="panelsStayOpen-collapseEleven" class="accordion-collapse collapse"
          ...
          <div class="accordion-body">
            <div class="row">
              <div class="col-6" style="position: relative;"><input class="form-check-input" type="checkbox" value=""
            ...
            <div class="row" style="height: 40px;">
              <div class="col-6" style="position: relative;"><input class="form-check-input" type="checkbox" value=""
                  id="flexCheckDefaultPotencialmente">
            ...
            <div class="row" style="display: flex; position: relative;">
              <p style="font-size: 1em;padding: 0;" class="textA">M:</p><input type="text" class="form-control"
                name="medico" id="" style="width: 200px; position: absolute; right: 5px;">
            </div>
            <div class="row" style="display: flex; position: relative;">
              <p style="font-size: 1em;padding: 0;" class="textA">S1:</p><input type="text" class="form-control"
                name="medicoS1" id="" style="width: 200px; position: absolute; right: 5px;">
            </div>
            <div class="row" style="display: flex; position: relative;">
              <p style="font-size: 1em;padding: 0;" class="textA">S2:</p><input type="text" class="form-control"
                name="medicoS2" id="" style="width: 200px; position: absolute; right: 5px;">
            </div>
            <div class="row" style="display: flex; position: relative;">
              <p style="font-size: 1em;padding: 0;" class="textA">S3:</p><input type="text" class="form-control"
                name="medicoS3" id="" style="width: 200px; position: absolute; right: 5px;">
            </div>
            <div class="row" style="display: flex; position: relative;">
              <p style="font-size: 1em;padding: 0;" class="textA">Demandante:</p><input type="text" class="form-control"
                name="Demandante" id="" style="width: 200px; position: absolute; right: 5px;">
            </div>
            <div class="row" style="display: flex; position: relative;">
              <p style="font-size: 1em;padding: 0;" class="textA">Equipe:</p><input type="text" class="form-control"
                name="Equipe" id="" style="width: 200px; position: absolute; right: 5px;">
            </div>
          </div>
        </div>
      </div>
        ...
        <div id="panelsStayOpen-collapseTwelve" class="accordion-collapse collapse"
          ...
          <div class="accordion-body">
            <div class="row" style="position: relative;">
              ...
              <label class="form-check-label" for="flexCheckDefault108" style="position: absolute; top: 0;left: 32px;">
                Aspiração
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault109">
              <label class="form-check-label" for="flexCheckDefault109" style="position: absolute; top: 0;left: 32px;">
                Avaliçao inicial
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault110">
              <label class="form-check-label" for="flexCheckDefault110" style="position: absolute; top: 0;left: 32px;">
                Avaliação dirigida
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault111">
              <label class="form-check-label" for="flexCheckDefault111" style="position: absolute; top: 0;left: 32px;">
                Avaliação continuada
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault112">
              <label class="form-check-label" for="flexCheckDefault112" style="position: absolute; top: 0;left: 32px;">
                Chave de Rautek
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault113">
              <label class="form-check-label" for="flexCheckDefault113" style="position: absolute; top: 0;left: 32px;">
                Cânula de Guedel
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault114">
              <label class="form-check-label" for="flexCheckDefault114" style="position: absolute; top: 0;left: 32px;">
                Desobstrução de V.A.
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault115">
              <label class="form-check-label" for="flexCheckDefault115" style="position: absolute; top: 0;left: 32px;">
                Emprego do D.E.A.
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault116">
              <label class="form-check-label" for="flexCheckDefault116" style="position: absolute; top: 0;left: 32px;">
                Gerenciamento de riscos
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault117">
              <label class="form-check-label" for="flexCheckDefault117" style="position: absolute; top: 0;left: 32px;">
                Limpeza de ferimentos
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault118">
              <label class="form-check-label" for="flexCheckDefault118" style="position: absolute; top: 0;left: 32px;">
                Curativos
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault119">
              <label class="form-check-label" for="flexCheckDefault119" style="position: absolute; top: 0;left: 32px;">
                Compressivo
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault120">
              <label class="form-check-label" for="flexCheckDefault120" style="position: absolute; top: 0;left: 32px;">
                Encravamento
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault121">
              <label class="form-check-label" for="flexCheckDefault121" style="position: absolute; top: 0;left: 32px;">
                Ocular
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault122">
              <label class="form-check-label" for="flexCheckDefault122" style="position: absolute; top: 0;left: 32px;">
                Queimadura
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault123">
              <label class="form-check-label" for="flexCheckDefault123" style="position: absolute; top: 0;left: 32px;">
                Simples
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault124">
              <label class="form-check-label" for="flexCheckDefault124" style="position: absolute; top: 0;left: 32px;">
                3 pontas
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault125">
              <label class="form-check-label" for="flexCheckDefault125" style="position: absolute; top: 0;left: 32px;">
                Imobilações
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault126">
              <label class="form-check-label" for="flexCheckDefault126" style="position: absolute; top: 0;left: 32px;">
                Membro INF. dir
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault127">
              <label class="form-check-label" for="flexCheckDefault127" style="position: absolute; top: 0;left: 32px;">
                Membro INF. esq
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault128">
              <label class="form-check-label" for="flexCheckDefault128" style="position: absolute; top: 0;left: 32px;">
                Membro SUP. dir
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault129">
              <label class="form-check-label" for="flexCheckDefault129" style="position: absolute; top: 0;left: 32px;">
                Membro SUP. esq
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault130">
              <label class="form-check-label" for="flexCheckDefault130" style="position: absolute; top: 0;left: 32px;">
                Quadril
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault131">
              <label class="form-check-label" for="flexCheckDefault131" style="position: absolute; top: 0;left: 32px;">
                Cervical
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault132">
              <label class="form-check-label" for="flexCheckDefault132" style="position: absolute; top: 0;left: 32px;">
                Maca sobre rodas
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault133">
              <label class="form-check-label" for="flexCheckDefault133" style="position: absolute; top: 0;left: 32px;">
                Maca rígida
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault134">
              <label class="form-check-label" for="flexCheckDefault134" style="position: absolute; top: 0;left: 32px;">
                Ponte
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault135">
              <label class="form-check-label" for="flexCheckDefault135" style="position: absolute; top: 0;left: 32px;">
                Retirado capacete
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault136">
              <label class="form-check-label" for="flexCheckDefault136" style="position: absolute; top: 0;left: 32px;">
                R.C.P
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault137">
              <label class="form-check-label" for="flexCheckDefault137" style="position: absolute; top: 0;left: 32px;">
                Rolamento 90°
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault138">
              <label class="form-check-label" for="flexCheckDefault138" style="position: absolute; top: 0;left: 32px;">
                Rolamento 180°
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault139">
              <label class="form-check-label" for="flexCheckDefault139" style="position: absolute; top: 0;left: 32px;">
                Tomada decisão
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault140">
              <label class="form-check-label" for="flexCheckDefault140" style="position: absolute; top: 0;left: 32px;">
                Tratado choque
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault141">
              <label class="form-check-label" for="flexCheckDefault141" style="position: absolute; top: 0;left: 32px;">
                Uso de cânula
              </label>
            </div>
            ...
            <div class="row" style="position: relative;">
              ...
              <label class="form-check-label" for="flexCheckDefault143" style="position: absolute; top: 0;left: 32px;">
                Uso KED
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault144">
              <label class="form-check-label" for="flexCheckDefault144" style="position: absolute; top: 0;left: 32px;">
                Uso TTF
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault145">
              <label class="form-check-label" for="flexCheckDefault145" style="position: absolute; top: 0;left: 32px;">
                Ventilação suporte
              </label>
            </div>
            <div class="row" style="position: relative; height: 30px;display: flex;align-items: center;">
            ...
            <div class="row" style="position: relative;">
              ...
              <label class="form-check-label" for="flexCheckDefault148" style="position: absolute; top: 0;left: 32px;">
                Meios auxiliares
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault149">
              <label class="form-check-label" for="flexCheckDefault149" style="position: absolute; top: 0;left: 32px;">
                Celesc
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault150">
              <label class="form-check-label" for="flexCheckDefault150" style="position: absolute; top: 0;left: 32px;">
                Def. Civil
              </label>
            </div>
            <div class="row" style="position: relative;">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault151">
              <label class="form-check-label" for="flexCheckDefault151" style="position: absolute; top: 0;left: 32px;">
                IGP / PC
              </label>
            </div>
            <div class="row" style="position: relative; height: 46px;display: flex; align-items: center;">
              ...
              <label class="form-check-label" for="flexCheckDefault152" style="position: absolute; top: 0;left: 32px;">
            ...
            <div class="row" style="position: relative; height: 46px;display: flex; align-items: center;">
              ...
              <label class="form-check-label" for="flexCheckDefault153" style="position: absolute; top: 0;left: 32px;">
                <div class="btn-group dropend"
                  style="display: flex; align-items: center; width: 100px;padding-top: 4px; padding-bottom: 4px">
                  <button type="button" class="btn btn-secondary dropdown-toggle"
                    style="display: flex; align-items: center; width: 100px;" data-bs-toggle="dropdown"
            ...
            <div class="row" style="position: relative;">
              ...
              <label class="form-check-label" for="flexCheckDefault154" style="position: absolute; top: 0;left: 32px;">
                CIT
              </label>
            </div>
          ...
          <div id="panelsStayOpen-collapseFifteen" class="accordion-collapse collapse"
            ...
            <div class="accordion-body">
              <div class="row" style="position: relative;height: 40px">Eu: <input type="text" name=""
                  class="form-control" id="" style="width: 250px; position: absolute; right: 5px;"></div>
              <div class="row" style="position: relative;height: 40px">Portador da carteira de identidade RG Nº <input
                  type="text" name="" class="form-control" id="" style="width: 80px; position: absolute; right: 5px;">
              </div>
              <div class="row" style="position: relative;height: 40px">Incrito no CPF sob nº <input type="text" name=""
                  class="form-control" style="width: 100px; position: absolute; right: 5px;" id=""></div>
              <div class="row" style="height:260px;">Na qualidade de vítima/Paciente, Usando dos direitos que a lei me
                garante, me recuso neste ato o atendimento e/ou transporte oferecido pelos bombeiros voluntários de
                Guaramirim/SC, e assumo, individualmente a responsibilidade pelas consequências que possam ocorrer por
                razão da minha recusa. Declaro que fui devidamente informado sobre o procedimento pelo qual eu deveria
          ...
          <div id="panelsStayOpen-collapseEighteen" class="accordion-collapse collapse"
            ...
            <div class="accordion-body">
              ...
              <div class="row" style="padding-top: 5px; padding-bottom: 5px;">
                ...
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="flexRadioDefault10" id="flexRadioDefaultSim10">
                  <label class="form-check-label" for="flexRadioDefaultSim10">
                    Sim
                  </label>
                  <input class="form-check-input" type="radio" name="flexRadioDefault10" id="flexRadioDefaultNao10">
              ...
              <div class="row" style="padding-top: 5px; padding-bottom: 5px;">
                ...
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="flexRadioDefault11" id="flexRadioDefaultSim11">
                  <label class="form-check-label" for="flexRadioDefaultSim11">
                    Sim
                  </label>
                  <input class="form-check-input" type="radio" name="flexRadioDefault11" id="flexRadioDefaultNao11">
              ...
              <div class="row" style="padding-top: 5px; padding-bottom: 5px;">
                ...
                <div class="col-auto">
                  <input class="form-check-input" type="radio" name="flexRadioDefault12" id="flexRadioDefaultSim12">
                  <label class="form-check-label" for="flexRadioDefaultSim12">
                    Sim
                  </label>
                  <input class="form-check-input" type="radio" name="flexRadioDefault12" id="flexRadioDefaultNao12">
          ...
          <div id="panelsStayOpen-collapseNineteen" class="accordion-collapse collapse"
            ...
            <div class="accordion-body">
              <div class="row" style="height: 30px;">
                ...
                <div class="col-4">
                  <input class="form-check-input" type="radio" name="flexRadioDefault5" id="flexRadioDefaultSim5">
                  <label class="form-check-label" for="flexRadioDefaultSim5">
                    Sim
                  </label>
                  <input class="form-check-input" type="radio" name="flexRadioDefault5" id="flexRadioDefaultNao5">
