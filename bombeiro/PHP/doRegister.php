                    ...
                    <div3 class="accordion-body" style="padding: 0;">
                        ...
                        <div2 class="row h-auto" style="font-size: 12px;">
                            ...
                            <div1 class="col-5" id="maior5">Maiores de 5 anos <br>
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="Espontânea" id="flexCheckDefault20"
                                        name="Abertura">
                                ...
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="Comando Verbal" id="flexCheckDefault21"
                                        name="Abertura">
                                ...
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="Estímulo Doloroso" id="flexCheckDefault22"
                                        name="Abertura">
                            ...
                            <div1 class="col-5 none" id="menor5">Menores de 5 anos <br>
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="Espontânea" id="flexCheckDefault24"
                                        name="Abertura">
                                ...
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="Comando Verbal" id="flexCheckDefault25"
                                        name="Abertura">
                                ...
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="Estímulo Doloroso" id="flexCheckDefault26"
                                        name="Abertura">
                        ...
                        <div class="row h-auto" style="font-size: 12px;">
                            ...
                            <div1 class="col-5" id="maior7">
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="Orientado" id="flexCheckDefault28"
                                        name="RespostaVerbal">
                                ...
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="Palavras inapropriadas" id="flexCheckDefault30"
                                        name="RespostaVerbal">
                                ...
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="Palavras incompreensível" id="flexCheckDefault31"
                                        name="RespostaVerbal">
                            ...
                            <div1 class="col-5 none" id="menor6">
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="Palavras e Frases Apropriadas" id="flexCheckDefault33"
                                        name="RespostaVerbal">
                                ...
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="Palavras inapropriadas" id="flexCheckDefault34"
                                        name="RespostaVerbal">
                                ...
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="Choro Persistente ou Gritos" id="flexCheckDefault35"
                                ...
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="Sons incompreensível" id="flexCheckDefault36"
                                        name="RespostaVerbal">
                                ...
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="Nenhuma Resposta Verbal" id="flexCheckDefault37"
                                        name="RespostaVerbal">
                        ...
                        <div class="row h-auto" style="font-size: 12px;">
                            ...
                            <div1 class="col-4 p-0" id="maior6">
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="Obedece Comandos" id="flexCheckDefault38"
                                        name="RespostaMotora">
                                ...
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="Localiza Dor" id="flexCheckDefault39"
                                        name="RespostaMotora">
                                ...
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="Movimento de Retirada" id="flexCheckDefault40"
                                        name="RespostaMotora">
                                ...
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="Flexão Anormal" id="flexCheckDefault41"
                                        name="RespostaMotora">
                                ...
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="Extensão Anormal" id="flexCheckDefault42"
                                        name="RespostaMotora">
                            ...
                            <div1 class="col-6 p-0 none" id="menor7">
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="Obedece Prontamente" id="flexCheckDefault44"
                                        name="RespostaMotora">
                                ...
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="Localiza Dor ou Estímulo Tátil" id="flexCheckDefault45"
                                        name="RespostaMotora">
                                ...
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="Retirada do Segmento Estímulado" id="flexCheckDefault46"
                                        name="RespostaMotora">
                                ...
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="Flexão Anormal(decorticação)" id="flexCheckDefault47"
                                        name="RespostaMotora">
                                ...
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="Extensão Anormal(decerfração)" id="flexCheckDefault48"
                                        name="RespostaMotora">
                                ...
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="Ausência Pararela Flácida" id="flexCheckDefault49"
                                        name="RespostaMotora">
                ...
                <div id="panelsStayOpen-collapseFive" class="accordion-collapse collapse"
                    ...
                    <div class="accordion-body">
                        <div class="row" style="height: 125px; font-size: 12px; align-items: center; ">
                            <div class="col-3"><input class="form-check-input" type="checkbox" name="Psiquiátrico"
                                    id="Psiquiátrico">
                                <label class="form-check-label" for="Psiquiátrico">
                                    Psiquiátrico
                                </label>
                            </div>
                            <div class="col-3"><input class="form-check-input" type="checkbox" name="Obstérico"
                                    id="Obstérico">
                        ...
                        <div class="row" style="height: 125px; font-size: 12px; align-items: center;">
                            <div class="col-3"><input class="form-check-input" type="checkbox" name="Respiratório"
                                    id="Respiratório">
                            ...
                            <div class="col-3"><input class="form-check-input" type="checkbox" name="Diabetes"
                                    id="Diabetes">
                                <label class="form-check-label" for="Diabetes">
                                    Diabetes
                                </label>
                            </div>
                            <div class="col-3"><input class="form-check-input" type="checkbox" name="Hiperglicemia"
                                    id="Hiperglicemia" style="display: block;">
                        ...
                        <div class="row" style="height: 180px; font-size: 12px; align-items: center; ">
                            <div class="col-3"><input class="form-check-input" type="checkbox" name="Transporte"
                                    id="Transporte">
                                <label class="form-check-label" for="Transporte">
                                    Transporte
                                </label>
                            </div>
                            <div class="col-9" style="position: relative;"><input class="form-check-input"
                                    type="checkbox" name="Aereo" id="Aereo" style="display: block;">
                                ...
                                <label class="form-check-label" for="Clinico"
                                    ...
                                    Clínico
                                </label><input class="form-check-input" type="checkbox" name="Emergencial"
                                    id="Emergencial" style="display: block;">
                        ...
                        <div class="container">
                            ...
                            <div class="container">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="flexCheckDefault176" name="cabeca">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="flexCheckDefault177" name="pescoco">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="flexCheckDefault178" name="ant">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="flexCheckDefault179" name="pos">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="flexCheckDefault180" name="genit">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="flexCheckDefault181" name="mid">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="flexCheckDefault182" name="mie">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="flexCheckDefault183" name="msd">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="flexCheckDefault184" name="mse">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="flexCheckDefault185" name="cabeca2">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="flexCheckDefault186" name="pescoco2">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="flexCheckDefault187" name="ant2">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="flexCheckDefault188" name="pos2">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="flexCheckDefault189" name="genit2">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="flexCheckDefault190" name="mid2">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="flexCheckDefault191" name="mie2">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="flexCheckDefault192" name="msd2">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="flexCheckDefault193" name="mse2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="flexCheckDefault194" name="cabeca3">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="flexCheckDefault195" name="pescoco3">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="flexCheckDefault196" name="ant3">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="flexCheckDefault197" name="pos3">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="flexCheckDefault198" name="genit3">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="flexCheckDefault199" name="mid3">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="flexCheckDefault200" name="mie3">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="flexCheckDefault201" name="msd3">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="flexCheckDefault202" name="mse3">
            ...
            <div class="accordion-item">
              ...
              -->
                        ...
                        <div class="row" style="position: relative; display: flex; align-items: center;height: 46px;">
                            ...
                            <input type="text" name="outrosMeios" class="form-control"
            ...
            <div class="accordion-item">
                ...
                <div id="panelsStayOpen-collapseThirteen" class="accordion-collapse collapse"
                    ...
                    <div class="accordion-body">
                        ...
                        <div class="row"
                            style="padding-top: 4px; padding-bottom: 4px; display: flex; align-items: center;">
                            <div class="col-4" style="position: relative;">
                    ...
                    <div id="panelsStayOpen-collapseFourteen" class="accordion-collapse collapse"
                        ...
                        <div class="accordion-body">
                            ...
                            <div class="row"
                                ...
                                <div class="col-2"
                                    style="border-left: 1px solid black; border-right:1px solid black; padding: 0;display: flex;flex-direction: column;align-items: center;">
                                    <input type="text" name="Quant13" class="form-control"
                                ...
                                <div class="col-2"
                                    style="border-left: 1px solid black; border-right:1px solid black; padding: 0;display: flex;flex-direction: column;align-items: center;">
                                    <input type="text" name="Quant14" class="form-control"
                                        style="width: 80%;padding: 5px;">
                                </div>
                            </div>
                            <div class="row"
                ...
                <div class="accordion-item">
                    ...
                    <div id="panelsStayOpen-collapseFifteen" class="accordion-collapse collapse"
                        ...
                        <div class="accordion-body">
                            ...
                            <div class="row" style="position: relative;height: 40px">Incrito no CPF sob nº <input
                                    type="text" name="" class="form-control"
                                    style="width: 100px; position: absolute; right: 5px;" id=""></div>
                            ...
                            <div class="row" style="position: relative;height: 40px">Testemunha: <input type="text"
                                    name="" class="form-control" style="width: 125px; position: absolute; right: 5px;"
                                    id=""></div>
