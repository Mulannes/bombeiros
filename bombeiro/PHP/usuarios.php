                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <div class="container">
                            <div class="row align-items-center">
                                ...
                                <div class="col text-center">
                                    <p class="h6" style="margin: 0;">' . $email . '</p>
                                </div>
                                <div class="col text-center">
                                    <p class="h6" style="margin: 0;">' . $tipo . '</p>
                                </div>
                                <div class="col text-center" style="align-items: center;">
                                    <div class="btn-group" role="group" style="margin-bottom: 0;">
                                        ...
                                        <li><a class="dropdown-item" href="alterar_tipo_usuario.php?id=' . $id . '">Tornar admin/user</a></li>
                                        <li><a class="dropdown-item text-danger" href="#" onclick="excluirUsuario(' . $id . ')">Excluir</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        // Redirecionar para 'usuarios.php' após meio segundo
                        setTimeout(function () {
                            window.location.href = 'usuarios.php';
                        }, 200);
                    } else {
                        console.error('Erro ao excluir o usuário:', response.error);
                        alert('Erro ao excluir o usuário: ' + response.error);
                    }
                },
                error: function (error) {
                    console.error('Erro na requisição:', error);
                    alert('Erro ao excluir o usuário. Consulte o console para obter detalhes.');
                }
            });
        }
    }
